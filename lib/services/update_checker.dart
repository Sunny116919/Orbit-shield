...
class UpdateChecker {
  static Future<void> checkForUpdate(BuildContext context, String jsonUrl) async {
    try {
  ...
  static void _showUpdateDialog(BuildContext context, String url, String notes, String version) {
    showDialog(
      context: context,
  ...
  static Future<void> _startUpdate(BuildContext context, String url) async {
    try {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Downloading update... check notification bar")),
      );
