...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.nicxonsolutions.device_apps_plus.DeviceAppsPlusPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin device_apps_plus, com.nicxonsolutions.device_apps_plus.DeviceAppsPlusPlugin", e);
    }
    try {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.sim_data.SimDataPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_sim_data, com.example.sim_data.SimDataPlugin", e);
    }
    try {
